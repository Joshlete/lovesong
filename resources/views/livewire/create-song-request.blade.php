<div>
    <!-- Song Price Display - Prominent position at top -->
    <div class="mb-8">
        <div class="bg-gradient-to-r from-green-500 to-emerald-600 rounded-2xl p-6 text-white shadow-xl relative overflow-hidden">
            <div class="absolute inset-0 opacity-10">
                <div class="absolute top-4 right-6 w-12 h-12 bg-white rounded-full animate-pulse"></div>
                <div class="absolute bottom-4 left-8 w-8 h-8 bg-white rounded-full animate-bounce"></div>
            </div>
            
            <div class="relative z-10 flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold mb-2">💰 Song Creation Price</h2>
                    <p class="text-white/90">Professional custom song creation</p>
                </div>
                <div class="text-right">
                    <div class="text-4xl font-black">${{ number_format($this->getSongPrice(), 2) }}</div>
                    <p class="text-white/80 text-sm">Payment after creation</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <form wire:submit="submit" class="space-y-8">
        ...
        <div class="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6 border border-purple-200">
            ...
            <div class="space-y-6" x-data="{ style: @entangle('style'), mood: @entangle('mood') }">
                ...
                <div>
                    ...
                    @enderror
                    <p class="mt-1 text-sm text-gray-500">What would you like to call your song?</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <!-- Custom Style (conditional) - keep in DOM, toggle with Alpine to avoid Livewire diff collisions -->
                    ...
                    <div class="space-y-4">
                        ...
                        <!-- Custom Mood (conditional) - keep in DOM, toggle with Alpine to avoid Livewire diff collisions -->
        ...
        <div class="bg-gradient-to-r from-purple-100 to-pink-100 rounded-xl p-6 border border-purple-200">
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-lg font-bold text-purple-900">Ready to Create Your Song?</h3>
                    <p class="text-purple-700 text-sm">We'll start working on your custom song immediately</p>
                </div>
